...
},{}],"dhbLe":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "c2a88f7e30f378dc";
...
},{}],"llE6h":[function(require,module,exports) {
...
window.onscroll = function() {
    ...
    if (scrollPosition < 30) {
        ...
        for(var k = 0; k < navlink.length; k++)navlink[k].classList.remove("active");
    }
...
window.addEventListener("scroll", function(e) {
    ...
    if (scrollpos > 1) document.getElementById("enterprise-nav").classList.add("bg-light");
...
content.addEventListener("loading-screen", ()=>{
    loadWrapper.classList.remove("fadeout");
    loadWrapper.classList.remove("hide");
}, false);
content.addEventListener("end-load", ()=>loadWrapper.classList.add("hide", "fadeout"), false);
const contactForm = document.getElementById("contact-form");
let name, email, message;
contactForm.addEventListener("submit", (e1)=>{
    e1.preventDefault();
    ...
    if (!obj.err) {
        ...
        (0, _axiosDefault.default).post("./contactForm.php", obj, {
            headers: {
...
},{}]},["1xC6H","dhbLe","llE6h"], "llE6h", "parcelRequire2d1f")

//# sourceMappingURL=index.30f378dc.js.map
