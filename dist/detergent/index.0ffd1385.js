...
},{}],"lmxAY":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "9af7da2c0ffd1385";
...
},{}],"6j9yV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _contactForm = require("./contact-form");
var _slider = require("./slider");
var _loadingEvent = require("./loading-event");
document.getElementById("content").style.opacity = 0;
document.onreadystatechange = function() {
    var state = document.readyState;
    if (state == "interactive") ;
    else if (state == "complete") setTimeout(function() {
...
// });
/*contact form  action */ const contactForm = document.getElementById("contact-form");
contactForm.addEventListener("submit", (0, _contactForm.submitForm));
/* End contact form */ /* Underline animation under banner texts */ const line = document.querySelectorAll(".line");
const bannerWrapper = {};
...
window.addEventListener("scroll", (e)=>{
    for(var i in bannerWrapper)if (window.scrollY >= bannerWrapper[i] - 300) line[i].classList.add("line_animation"); //Add animation
    if (window.scrollY >= c_height - 300) verticalLine.setAttribute("style", `height:95%`);
});

},{"axios":"jo6P5","./contact-form":"6sdPN","./slider":"k533j","./loading-event":"5HMFj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
...
},{"./../utils":"5By4s"}],"6sdPN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const submitForm = (e1)=>{
    ...
    if (!obj.err) {
        ...
        axios.post("./contactForm.php", obj, {
            headers: {
                "Content-Type": "application/json"
            }
        }).then((res)=>{
...
const showMessage = (data)=>{
    ...
    const p = document.createElement("p");
    !data.err ? p.textContent = "Message Sent Succesfully" : p.textContent = "Message was not sent";
    messageArea.appendChild(p);
    !data.err ? messageArea.classList.add("alert-success") : messageArea.classList.add("alert-danger");
...
const validateInput = (obj)=>{
    ...
    Object.entries(obj).forEach((entry)=>{
        ...
        if (!value) err.push(toTitleCase(key) + " field cannot be left empty");
        return;
    });
...
},{"./loading-event":"5HMFj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5HMFj":[function(require,module,exports) {
...
window.addEventListener("loading-screen", ()=>{
    loadWrapper.classList.remove("fadeout");
    loadWrapper.classList.remove("hide");
}, false);
window.addEventListener("end-load", ()=>loadWrapper.classList.add("hide", "fadeout"), false);
...
},{}],"k533j":[function(require,module,exports) {
...
},{}]},["1xC6H","lmxAY","6j9yV"], "6j9yV", "parcelRequire2d1f")

//# sourceMappingURL=index.0ffd1385.js.map
